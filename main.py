import random, os, copy, torch, argparse
import pandas as pd
            ...
            if f1 > best_f1:
                ...
                with torch.no_grad():
                    for test_essay_id, test_token, test_label in test_dataloader:
                        ...
                        batch_loss = criterion(logits, test_label)
...
if __name__ == '__main__':
    ...
    master_df = pd.read_excel("test_data/fall_2018_test.xlsx")
    initial_model = EvidenceScoringModel(args)
    ...
    for fold, (train_val_idx, test_idx) in enumerate(kfold.split(master_df)):
        ...
        val_dataset = TextDataset(args, val_data)
    ...
    print('{:<15}{:<15}{:<15}{:<15}'.format("avg_precision", "avg_recall", "avg_f1", "avg_kappa"))
    # print('{:<15.2f}{:<15.2f}{:<15.2f}{:<15.2f}{:<15.2f}{:<15.2f}'.format(desirable_f1, undesirable_f1, avg_precision, avg_recall, avg_f1, avg_kappa))
    print('{:<15.2f}{:<15.2f}{:<15.2f}{:<15.2f}'.format(avg_precision, avg_recall, avg_f1, avg_kappa))
